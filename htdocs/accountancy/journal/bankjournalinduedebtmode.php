...
/**
 * \file		htdocs/accountancy/journal/bankjournalinduedebtmode.php
 * \ingroup		Accountancy
 * \brief		Page with bank journal in due debt mode
 */
...
// Get informations of finance journal
...
dol_syslog('accountancy/journal/bankjournalinduedebtmode.php', LOG_DEBUG);
$result = $db->query($sql);
if ($result) {
	$tabfac = array ();
	$tabht = array ();
