...
$langs->loadLangs(array("compta","bills","admin","accounting","salaries"));
...
if ($resql)
{
	...
	print_barre_liste($langs->trans('ListAccounts'), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, '', $num, $nbtotalofrecords, 'title_accounting', 0, $newcardbutton, '', $limit);
