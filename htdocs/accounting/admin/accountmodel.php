...
$langs->loadLangs(array("errors","admin","companies","resource","holiday","compta","accounting","hrm"));
...
if (GETPOST('actionadd', 'alpha') || GETPOST('actionmodify', 'alpha'))
{
	...
	foreach ($listfield as $f => $value)
	{
		...
		if ((! isset($_POST[$value]) || $_POST[$value]=='')
			&& (! in_array($listfield[$f], array('decalage','module','accounting_code','accounting_code_sell','accounting_code_buy'))  // Fields that are not mandatory
...
print load_fiche_titre($titre, $linkback, 'title_accounting');
