...
/**
 * \file	htdocs/accounting/admin/categories.php
 * \ingroup Accounting
...
$linkback = '<a href="'.DOL_URL_ROOT.'/accounting/admin/categories_list.php?restore_lastsearch_values=1">'.$langs->trans("BackToList").'</a>';
