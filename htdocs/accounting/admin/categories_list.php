...
$langs->loadLangs(array("errors","admin","companies","resource","holiday","accounting","hrm"));
...
if ($id)
{
    ...
    if ($tabname[$id])
    {
        ...
        foreach ($fieldlist as $field => $value)
        {
            ...
            if ($fieldlist[$field]=='accounting_code') {
                $valuetoshow=$langs->trans("AccountingCode");
            }
            if ($fieldlist[$field]=='accounting_code_sell') {
                $valuetoshow=$langs->trans("AccountingCodeSell");
            }
            if ($fieldlist[$field]=='accounting_code_buy') {
                $valuetoshow=$langs->trans("AccountingCodeBuy");
            }
