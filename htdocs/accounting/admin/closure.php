...
/**
 * \file		htdocs/accounting/admin/closure.php
 * \ingroup		Accounting
 * \brief		Page to define closure accounts
 */
...
$langs->loadLangs(array("compta","admin","accounting"));
...
$linkback = '';
print load_fiche_titre($langs->trans('MenuClosureAccounts'), $linkback, 'title_accounting');
