 ...
 * \ingroup		Accounting
 * \brief		Page to define default accounts
 */
...
$langs->loadLangs(array("compta","bills","admin","accounting","salaries","loan"));
...
$linkback = '';
print load_fiche_titre($langs->trans('MenuDefaultAccounts'), $linkback, 'title_accounting');
