...
$langs->loadLangs(array("compta","bills","accounting"));
...
$sql = "(SELECT p.rowid as product_id, p.accounting_code_sell as accounting ";
$sql .= " FROM  " . MAIN_DB_PREFIX . "product as p ";
$sql .= " WHERE p.accounting_code_sell >=0";
$sql .= " GROUP BY accounting ";
$sql .= ")";
$sql .= "UNION ALL(SELECT p.rowid as product_id, p.accounting_code_buy as accounting ";
$sql .= " FROM  " . MAIN_DB_PREFIX . "product as p ";
$sql .= " WHERE p.accounting_code_buy >=0";
$sql .= " GROUP BY accounting ";
$sql .= ") ";
