...
/**
 * \file		htdocs/accounting/bookkeeping/balancebymonth.php
 * \ingroup		Adccounting
...
$langs->loadLangs(array("bills","compta","accounting","other"));
...
dol_syslog('accounting/bookkeeping/balancebymonth.php:: $sql=' . $sql);
$result = $db->query($sql);
if ($result) {
