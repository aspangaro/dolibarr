 ...
 * \ingroup 	Accounting
 * \brief 		Tab to manage supplier lettering
 */
...
if ($resql) {
	...
	print '<input class="butAction" type="submit" value="' . $langs->trans('AccountingLettering') . '" name="lettering" id="lettering">';
	//print '<a class="butAction" href="'.$_SERVER["PHP_SELF"].'?socid=' . $object->id . '&action=autolettrage">'.$langs->trans('AccountingAutoLettering').'</a>';
	print "</form>";
	$db->free($resql);
} else {
	dol_print_error($db);
