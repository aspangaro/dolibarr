 ...
 * \brief		File of class to manage accounting systems
 */

/**
 * Class to manage accounting systems
 */
class AccountingSystem
{
    ...
    /**
     * @var string Accounting System label
     */
    public $label;
	...
	/**
	 * Insert accounting system name into database
	 *
