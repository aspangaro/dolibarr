...
/**
 * \file        htdocs/accounting/class/bookkeeping.class.php
...
class BookKeeping extends CommonObject
{
    ...
    public function create(User $user, $notrigger = false)
    {
		...
		$sql .= " AND entity IN (" . getEntity('accounting') . ")";
		...
		if ($resql) {
			...
			if ($row->nb == 0)
			{
				...
				$sqlnum .= " AND entity IN (" . getEntity('accounting') . ")";
				...
				if (empty($this->piece_num)) {
					...
					$sqlnum .= " FROM " . MAIN_DB_PREFIX . $this->table_element;
					$sqlnum .= " WHERE entity IN (" . getEntity('accounting') . ")";
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = DOL_URL_ROOT.'/accounting/bookkeeping/card.php?piece_num='.$this->piece_num;
	...
	/**
	 * Load all informations of accounting document
	 *
	...
	public function transformTransaction($direction = 0, $piece_num = '')
	{
		...
		$sql .= " AND ab.entity IN (" . getEntity('accounting') . ")";
    ...
    */
	...
	public function get_compte_racine($account = null)
	{
		...
		$sql .= " AND aa.entity IN (" . getEntity('accounting') . ")";
    ...
    public function get_compte_desc($account = null)
    {
		...
		$sql .= " WHERE aa.entity IN (" . getEntity('accounting') . ")";
