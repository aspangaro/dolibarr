...
/**
 * \file      	htdocs/accounting/class/lettering.class.php
 * \ingroup 	Advanced accounting
 * \brief 		File of class for lettering
 */

include_once DOL_DOCUMENT_ROOT . "/accounting/class/bookkeeping.class.php";
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql) ) {
				...
				if ($obj->type == 'payment_supplier')
				{
					...
					$sql .= " AND fac.entity IN (".getEntity('invoice', 0).")";// We don't share object for accounting
					$sql .= " AND ( ";
					if (! empty($object->code_compta)) {
						$sql .= "  bk.subledger_account = '" . $object->code_compta . "'  ";
					}
