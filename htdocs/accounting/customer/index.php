...
if ($action == 'validatehistory') {
	...
	if ($db->type == 'pgsql') {
		...
		$sql1 .= " AND accnt.active = 1 AND p.accounting_code_sell=accnt.account_number";
...
print load_fiche_titre($langs->trans("CustomersVentilation") . " " . $textprevyear . " " . $langs->trans("Year") . " " . $year_start . " " . $textnextyear, '', 'title_accounting');
