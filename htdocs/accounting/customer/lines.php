...
$langs->loadLangs(array("bills","compta","accounting","productbatch"));
...
$sql.= " p.rowid as product_id, p.fk_product_type as product_type, p.ref as product_ref, p.label as product_label, p.accounting_code_sell, aa.rowid as fk_compte, aa.account_number, aa.label as label_compte,";
...
if ($result) {
	...
	print_barre_liste($langs->trans("InvoiceLinesDone"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, '', $num_lines, $nbtotalofrecords, 'title_accounting', 0, '', '', $limit);
