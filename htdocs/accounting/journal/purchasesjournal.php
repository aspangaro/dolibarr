...
$sql .= " p.accounting_code_buy , aa.rowid as fk_compte, aa.account_number as compte, aa.label as label_compte";
...
$sql .= " AND f.entity IN (" . getEntity('facture_fourn', 0) . ")";  // We don't share object for accounting
...
if ($result) {
	...
	while ( $i < $num ) {
		...
		$compta_tva = (! empty($vatdata['accounting_code_buy']) ? $vatdata['accounting_code_buy'] : $cpttva);
