...
$langs->loadLangs(array("compta","bills","other","accounting","productbatch"));
...
if ($result) {
	...
	print_barre_liste($langs->trans("InvoiceLinesDone"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num_lines, $nbtotalofrecords, 'title_accounting', 0, '', '', $limit);
