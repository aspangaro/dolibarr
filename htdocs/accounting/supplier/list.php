...
$hookmanager->initHooks(array('accountingsupplierlist'));
...
$sql.= " p.rowid as product_id, p.ref as product_ref, p.label as product_label, p.fk_product_type as type, p.accounting_code_buy as code_buy, p.tva_tx as tva_tx_prod,";
...
$sql.= " LEFT JOIN " . MAIN_DB_PREFIX . "accounting_account as aa ON p.accounting_code_buy = aa.account_number AND aa.fk_pcg_version = '" . $chartaccountcode."' AND aa.entity = " . $conf->entity;
