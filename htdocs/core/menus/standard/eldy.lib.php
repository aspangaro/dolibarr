		...
		if ($mainmenu == 'accountancy')
		{
			...
			if (! empty($conf->accounting->enabled))
			{
                ...
                if ($usemenuhider || empty($leftmenu) || preg_match('/accountancy_admin/', $leftmenu)) {
                    ...
                    $newmenu->add("/accountancy/admin/subledger.php?mainmenu=accountancy&leftmenu=accountancy_admin", $langs->trans("ChartOfSubAccounts"), 1, $user->rights->accounting->chartofaccount, '', $mainmenu, 'accountancy_admin_chart', 41);
