...
--UPDATE llx_c_type_fees SET accounting_code = '625100' WHERE code = 'EX_KME';
--UPDATE llx_c_type_fees SET accounting_code = '606150' WHERE code = 'EX_FUE';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_HOT';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_PAR';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_TOL';
--UPDATE llx_c_type_fees SET accounting_code = '637800' WHERE code = 'EX_TAX';
--UPDATE llx_c_type_fees SET accounting_code = '648100' WHERE code = 'EX_IND';
--UPDATE llx_c_type_fees SET accounting_code = '606300' WHERE code = 'EX_SUM';
--UPDATE llx_c_type_fees SET accounting_code = '606400' WHERE code = 'EX_SUO';
--UPDATE llx_c_type_fees SET accounting_code = '613000' WHERE code = 'EX_CAR';
--UPDATE llx_c_type_fees SET accounting_code = '618100' WHERE code = 'EX_DOC';
--UPDATE llx_c_type_fees SET accounting_code = '625710' WHERE code = 'EX_CUR';
--UPDATE llx_c_type_fees SET accounting_code = '625700' WHERE code = 'EX_OTR';
--UPDATE llx_c_type_fees SET accounting_code = '626100' WHERE code = 'EX_POS';
--UPDATE llx_c_type_fees SET accounting_code = '615300' WHERE code = 'EX_CAM';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_EMM';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_GUM';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_BRE';
--UPDATE llx_c_type_fees SET accounting_code = '606150' WHERE code = 'EX_FUE_VP';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_TOL_VP';
--UPDATE llx_c_type_fees SET accounting_code = '625160' WHERE code = 'EX_PAR_VP';
--UPDATE llx_c_type_fees SET accounting_code = '615300' WHERE code = 'EX_CAM_VP';
