...
ALTER TABLE llx_accounting_bookkeeping CHANGE COLUMN piece_num piece_num varchar(128) NOT NULL;
ALTER TABLE llx_accounting_bookkeeping_tmp CHANGE COLUMN piece_num piece_num varchar(128) NOT NULL;
