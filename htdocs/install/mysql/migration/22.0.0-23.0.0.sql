...
-- fk_accounting_category into llx_accounting_account as deprecated, move to llx_accounting_category_account
INSERT INTO llx_accounting_category_account (fk_accounting_category, fk_accounting_account)
SELECT fk_accounting_category, rowid
FROM llx_accounting_account
WHERE fk_accounting_category IS NOT NULL;
