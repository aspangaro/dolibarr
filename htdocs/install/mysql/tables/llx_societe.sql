...
(
  ...
  accountancy_account_general_customer  varchar(32),                                -- customer accountancy general account
  code_compta                           varchar(32),                                -- customer accountancy sub-ledger account
  accountancy_account_general_supplier  varchar(32),                                -- supplier accountancy general account
  code_compta_fournisseur               varchar(32),                                -- supplier accountancy sub-ledger account
  ...
  tva_assuj                             tinyint        DEFAULT 1,                   -- subject to VAT or not
  localtax1_assuj                       tinyint        DEFAULT 0,                   -- subject to localtax1 or not
  localtax1_value                       double(7,4),
  localtax2_assuj                       tinyint        DEFAULT 0,                   -- subject to localtax2 or not
